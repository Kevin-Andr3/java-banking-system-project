...
public class VentanaProgramadores extends JDialog implements ActionListener {
	...
	private JLabel lblDeLaCruzVillugas;
	...
	public VentanaProgramadores() {
		...
		{
			lblFoto2 = new JLabel("");
			lblFoto2.setIcon(new ImageIcon(VentanaProgramadores.class.getResource("/imagen/avatar.jpg")));
		...
		{
			lblFoto3 = new JLabel("");
			lblFoto3.setIcon(new ImageIcon(VentanaProgramadores.class.getResource("/imagen/avatar.jpg")));
		...
		{
			lblFoto4 = new JLabel("");
			lblFoto4.setIcon(new ImageIcon(VentanaProgramadores.class.getResource("/imagen/avatar.jpg")));
		...
		}
		{
			...
			lblFoto5.setIcon(new ImageIcon(VentanaProgramadores.class.getResource("/imagen/avatar.jpg")));
		...
		{
			lblDeLaCruzVillugas = new JLabel("De La Cruz Villugas");
			lblDeLaCruzVillugas.setHorizontalAlignment(SwingConstants.CENTER);
			lblDeLaCruzVillugas.setForeground(new Color(90, 90, 90));
			lblDeLaCruzVillugas.setFont(new Font("Arial", Font.BOLD, 15));
			lblDeLaCruzVillugas.setBounds(690, 310, 137, 18);
			getContentPane().add(lblDeLaCruzVillugas);
		}
		{
		...
		{
			lblFoto1 = new JLabel("");
			lblFoto1.setIcon(new ImageIcon(VentanaProgramadores.class.getResource("/imagen/avatar.jpg")));
